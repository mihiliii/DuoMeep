...
export default function AdminUsers() {
  ...
  const [appliedAccount, setAppliedAccount] = useState<string>('');
  ...
  }, [appliedUsername, appliedAccount, currentPage, version]);

  function handleApplySearch(): void {
    setAppliedUsername(newUsername);
    setAppliedAccount(newAccount);
    setCurrentPage(1);
  }
  ...
  return (
    <>
      <div className="admin-search-row">
        <label className="matchme-field stack admin-search-field">
        ...
        <button type="button" className="admin-apply" onClick={handleApplySearch}>
          Search
        </button>
      </div>
